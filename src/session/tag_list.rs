...
mod test {
    ...
    fn get_index_of() {
        ...
        assert_eq!(
            tag_list.get_index_of(&tag_list.get_with_name("A").unwrap()),
            Some(0)
        );
        assert_eq!(
            tag_list.get_index_of(&tag_list.get_with_name("B").unwrap()),
            Some(1)
        );
        assert_eq!(
            tag_list.get_index_of(&tag_list.get_with_name("C").unwrap()),
            Some(2)
        );
    }
